import allure
import pytest
from pages.important_questions_page import ImportantQuestionsPage, ImportantQuestionsTexts
...
def test_important_questions(driver, question_locator, answer_locator, expected_text):
